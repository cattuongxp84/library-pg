...
const { borrowBook, returnBook, renewBorrow, getBorrows, getMyBorrows, generateBill, exportBorrowHistory } = require('../controllers/borrowController');
const { protect: p3, authorize: a3 } = require('../middleware/auth');
r3.get('/', p3, a3('admin','librarian'), getBorrows);
r3.get('/export', p3, a3('admin','librarian'), exportBorrowHistory);
